...
const namePrefix = "eMojoCollection";
const description = "Collection of character called eMojo inspired by the emojis";
...
const CONTRACT_NAME = 'eMojoCollection';
const CONTRACT_SYMBOL = 'EMC';
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = "0xce8561002b7c65c85F2a4e90a000605B371802fB"; // If you want to manually include it

// Generic Metadata is optional if you want to reveal your NFTs
const GENERIC = true; // Set to true if you want to upload generic metas and reveal the real NFTs in the future
const GENERIC_TITLE = CONTRACT_NAME; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "Reveal me and get your own eMojo now!"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreiekkzdhif2i2wh33atwa2koz2wv2nf3ihhxksf2mp5izymx7pog5y"; // Replace with your generic image that will display for all NFTs pre-reveal.
